 ...
 */
public class RandomCambodiaPhone extends AbstractFunction {

    private static final Logger log = LoggerFactory.getLogger(RandomCambodiaPhone.class);
    ...
    private static final String KEY = "__RandomCambodiaPhone";
