...
public class ExtentReportCollector extends AbstractTestElement implements TestStateListener, ThreadListener, SampleListener {
    public static final String REPORTNAME = "ReportName";
    public static final String ISAPPEND = "IsAppend";

    private ExtentReports extent;

    public ExtentReportCollector() {
        super();
    }

    public ExtentReportCollector(String name) {
        this();
        setName(name);
    }
