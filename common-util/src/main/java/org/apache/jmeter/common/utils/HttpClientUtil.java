...
import org.apache.jmeter.common.utils.http.HttpHeader;
import org.apache.jmeter.common.utils.http.HttpRequestFileData;
...
public class HttpClientUtil {
    ...
    private static final Logger logger = LogUtil.getLogger(HttpClientUtil.class);
    ...
    public HttpClientUtil(String basicUrl) {
        this();
        this.basicUrl = basicUrl;
    }

    public HttpClientUtil(String protocol, String host, String port) {
        this();
